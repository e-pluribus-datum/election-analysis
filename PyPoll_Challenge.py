...
# Use variable for line separator
separator = "".ljust(25, "-")
...
# 2: Track the county with the largest turnout and the number of votes cast there
# activest is not a word
activist_county = ""
activist_votes = 0
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        txt_file.write(county_results)
         # 6f: Write an if statement to determine the most active county and get its vote count.
    ...
    # Double check here for line breaks
